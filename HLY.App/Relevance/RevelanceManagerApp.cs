...
namespace HLY.App
{
    public class RevelanceManagerApp : BaseStringApp<Relevance,HLYDBContext>
    {
        private readonly ILogger<RevelanceManagerApp> _logger;
        public RevelanceManagerApp(IUnitWork<HLYDBContext> unitWork, IRepository<Relevance,HLYDBContext> repository, IAuth auth, ILogger<RevelanceManagerApp> logger) : base(unitWork,
            repository, auth)
        {
            _logger = logger;
        }
