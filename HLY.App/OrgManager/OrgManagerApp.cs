...
namespace HLY.App
{
    public class OrgManagerApp : BaseTreeApp<SysOrg,HLYDBContext>
    {
        ...
        public OrgManagerApp(IUnitWork<HLYDBContext> unitWork, IRepository<SysOrg,HLYDBContext> repository,IAuth auth, 
