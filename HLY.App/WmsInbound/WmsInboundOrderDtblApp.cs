...
namespace HLY.App
{
    public class WmsInboundOrderDtblApp : BaseStringApp<WmsInboundOrderDtbl,HLYDBContext>
    {
        ...
        public WmsInboundOrderDtblApp(IUnitWork<HLYDBContext> unitWork, IRepository<WmsInboundOrderDtbl,HLYDBContext> repository,
