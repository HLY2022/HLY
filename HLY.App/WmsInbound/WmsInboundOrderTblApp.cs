...
namespace HLY.App
{
    public class WmsInboundOrderTblApp : BaseStringApp<WmsInboundOrderTbl,HLYDBContext>
    {
        ...
        public WmsInboundOrderTblApp(IUnitWork<HLYDBContext> unitWork, IRepository<WmsInboundOrderTbl,HLYDBContext> repository,
