...
namespace HLY.App
{
    public class UserManagerApp : BaseStringApp<User,HLYDBContext>
    {
        private RevelanceManagerApp _revelanceApp;
        private OrgManagerApp _orgManagerApp;
        
        public UserManagerApp(IUnitWork<HLYDBContext> unitWork, IRepository<User,HLYDBContext> repository,
