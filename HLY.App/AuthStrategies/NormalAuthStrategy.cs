...
namespace HLY.App
{
    ...
    /// 普通用户授权策略
    /// </summary>
    public class NormalAuthStrategy :BaseStringApp<User,HLYDBContext>, IAuthStrategy
    {
        ...
        public NormalAuthStrategy(IUnitWork<HLYDBContext> unitWork, IRepository<User,HLYDBContext> repository, DbExtension dbExtension) : base(unitWork, repository,null)
        {
