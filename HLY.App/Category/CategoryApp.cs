...
namespace HLY.App
{
    public class CategoryApp : BaseStringApp<Category,HLYDBContext>
    {
        /// <summary>
        /// 加载列表
        /// </summary>
        ...
        public CategoryApp(IUnitWork<HLYDBContext> unitWork, IRepository<Category,HLYDBContext> repository,IAuth auth) : base(unitWork, repository, auth)
        {
        }
    }
}