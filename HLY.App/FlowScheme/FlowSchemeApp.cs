...
namespace HLY.App
{
    public class FlowSchemeApp :BaseStringApp<FlowScheme,HLYDBContext>
    {
        ...
        public FlowSchemeApp(IUnitWork<HLYDBContext> unitWork, IRepository<FlowScheme,HLYDBContext> repository,IAuth auth) : base(unitWork, repository, auth)
        {
        }
    }
}
