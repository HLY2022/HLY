...
namespace HLY.App
{
    public class DbExtension
    {
        ...
        public DbExtension(IOptions<AppSetting> appConfiguration, HLYDBContext HLYDbContext, IHttpContextAccessor httpContextAccessor)
        {
            _appConfiguration = appConfiguration;
            _httpContextAccessor = httpContextAccessor;
            _contexts.Add(HLYDbContext);  //如果有多个DBContext，可以按HLYDBContext同样的方式添加到_contexts中
        }
        ...
        public List<BuilderTableColumn> GetTableColumnsFromDb(string moduleName)
        {
            ...
            const string domain = "HLY.repository.domain.";
