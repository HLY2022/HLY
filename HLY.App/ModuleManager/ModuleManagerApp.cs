...
namespace HLY.App
{
    public class ModuleManagerApp : BaseTreeApp<Module,HLYDBContext>
    {
        ...
        public ModuleManagerApp(IUnitWork<HLYDBContext> unitWork, IRepository<Module,HLYDBContext> repository
