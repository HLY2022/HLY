...
namespace HLY.App
{
    ...
    /// 文件管理
    /// </summary>
    public class FileApp : BaseStringApp<UploadFile,HLYDBContext>
    {
        ...
        public FileApp(IOptions<AppSetting> setOptions, IUnitWork<HLYDBContext> unitWork, IRepository<UploadFile,HLYDBContext> repository,
