...
namespace HLY.App
{
    public class FrmLeaveReqApp : BaseStringApp<FrmLeaveReq,HLYDBContext>, ICustomerForm
    {
        ...
        public FrmLeaveReqApp(IUnitWork<HLYDBContext> unitWork, IRepository<FrmLeaveReq,HLYDBContext> repository,
