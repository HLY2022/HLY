...
namespace HLY.App
{
    public class SysMessageApp : BaseStringApp<SysMessage,HLYDBContext>
    {
        ...
        public SysMessageApp(IUnitWork<HLYDBContext> unitWork, IRepository<SysMessage,HLYDBContext> repository,
