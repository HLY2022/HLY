...
namespace HLY.App
{
    ...
    /// 分类管理
    /// </summary>
    public class ResourceApp:BaseStringApp<Resource,HLYDBContext>
    {
        ...
        public ResourceApp(IUnitWork<HLYDBContext> unitWork, IRepository<Resource,HLYDBContext> repository
