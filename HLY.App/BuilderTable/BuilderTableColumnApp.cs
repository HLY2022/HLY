...
namespace HLY.App
{
    public class BuilderTableColumnApp : BaseStringApp<BuilderTableColumn,HLYDBContext>
    {
        
        private DbExtension _dbExtension;
        public BuilderTableColumnApp(IUnitWork<HLYDBContext> unitWork, IRepository<BuilderTableColumn,HLYDBContext> repository,
