...
using HLY.App;
using HLY.App.HostedService;
using HLY.Repository;
using HLY.WebApi.Model;
using Swashbuckle.AspNetCore.SwaggerUI;

namespace HLY.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
                    ...
                    option.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
                    {
                        ...
                        Flows = new OpenApiOAuthFlows
                        {
                            Implicit = new OpenApiOAuthFlow
                            {
                                ...
                                {
                                    {"HLYapi", "同意HLY.webapi 的访问权限"} //指定客户端请求的api作用域。 如果为空，则客户端无法访问
                                }
                            }
                        }
                    });
            ...
            services.AddControllers(option => { option.Filters.Add<HLYFilter>(); })
...
//                origins = new []
//                {
//                    "http://demo.HLY.net.cn:1803",
//                    "http://demo.HLY.net.cn:52789"
//                };
//            }
...
//                policy.AllowAnyHeader().AllowAnyMethod().AllowCredentials().WithOrigins(origins)));
            ...
            var connectionString = Configuration.GetConnectionString("HLYDBContext");
            logger.LogInformation($"系统配置的数据库类型：{JsonHelper.Instance.Serialize(dbtypes)}，连接字符串：{connectionString}");
            services.AddDbContext<HLYDBContext>();
        ...
        public void Configure(IApplicationBuilder app, IHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                c.IndexStream = () =>
                    GetType().GetTypeInfo().Assembly.GetManifestResourceStream("HLY.WebApi.index.html");
                ...
                c.OAuthClientId("HLY.WebApi"); //oauth客户端名称
