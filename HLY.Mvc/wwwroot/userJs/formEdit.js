layui.config({
    base: "/js/"
}).use(['form', 'vue', 'ztree', 'layer', 'utils', 'jquery', 'cookie','table', 'droptree', 'HLY', 'element'], function () {
    var form = layui.form,
            ...
            function (data) {
                ...
                setTimeout(function () {
                    if (obj.FrmType === 0) { 
	                    ...
	                    ue.setContent("复杂表单暂时只能在<a href='http://demo.HLY.net.cn:1803'>企业版</a>查看，开源版预计会在以后的开源版本中发布");
                    }
                }, 500);
            });
    } else {
