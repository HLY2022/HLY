...
namespace HLY.Repository
{
    
    public partial class HLYDBContext : DbContext
    {
        ...
        public HLYDBContext(DbContextOptions<HLYDBContext> options, ILoggerFactory loggerFactory, 
