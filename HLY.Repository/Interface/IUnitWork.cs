...
// Contact : Microsoft
// File: IUnitWork<HLYDBContext>.cs
// ***********************************************************************
...
namespace HLY.Repository.Interface
{
    /// <summary>
    /// 工作单元接口
    /// 使用详见：http://doc.HLY.net.cn/core/unitwork.html
    /// <para> 适合在一下情况使用:</para>
    ...
    public interface IUnitWork<TDbContext> where TDbContext:DbContext
    {
        ...
        /// <summary>
        /// 该方法不支持EF自带的事务,需要ExecuteWithTransaction配合才能实现事务控制,详见：http://doc.HLY.net.cn/core/unitwork.html
        /// </summary>
